...
class Wallets extends Component {
  constructor(props) {
    ...
    this.handleOnCreateWallet = this.handleOnCreateWallet.bind(this);
    this.handleOnDeleteWallet = this.handleOnDeleteWallet.bind(this);
  }
  ...
  loadWalletList() {
    ...
    console.log(
      `list wallets on blockchain ${this.props.coin} ${this.props.chain}`
    );
